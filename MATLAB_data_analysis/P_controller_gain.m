...
fileID = fopen('datalogs/controller_gain_estimation/P-controller/Kp=0.0025');
...
fileID1 = fopen('datalogs/controller_gain_estimation/P-controller/Kp=0.0050');
...
fileID2 = fopen('datalogs/controller_gain_estimation/P-controller/Kp=0.0075');
...
fileID3 = fopen('datalogs/controller_gain_estimation/P-controller/Kp=0.0100');
