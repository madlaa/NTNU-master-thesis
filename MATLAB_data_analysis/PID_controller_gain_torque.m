...
fileID = fopen('datalogs/controller_gain_estimation_torque/PID-controller-torque/Kp_T=0.4,Ki_T=0.00050,Kd_T=1.00000');
...
fileID1 = fopen('datalogs/controller_gain_estimation_torque/PID-controller-torque/Kp_T=0.4,Ki_T=0.00050,Kd_T=2.50000');
...
fileID2 = fopen('datalogs/controller_gain_estimation_torque/PID-controller-torque/Kp_T=0.4,Ki_T=0.00050,Kd_T=5.00000');
...
fileID3 = fopen('datalogs/controller_gain_estimation_torque/PID-controller-torque/Kp_T=0.4,Ki_T=0.00050,Kd_T=7.50000');
...
hold off;
lgd = legend('\fontsize{15} Referance torque','\fontsize{15} K_d\_T = 1.00000', '\fontsize{15} K_d\_T = 2.50000', '\fontsize{15} K_d\_T = 5.00000', '\fontsize{15} K_d\_T = 7.50000','Location','east');
title(lgd,'\fontsize{15} Gain parameters')
title('\fontsize{15} PID-controller - Step response for Tz');
